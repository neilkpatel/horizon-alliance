...
- `mailers.html` — Alliance Mailers page (daily strategy guides by acidrain239)
...
## Alliance Mailers
- `mailers.html` — Strategy guides written by acidrain239
...
### Mar 24, 2026
- Created `mailers.html` — Alliance Mailers page featuring 7 strategic guides by acidrain239
  - Day-specific playbooks: Sunday Prep, Monday VS & Warzone, Tuesday Builders Day
...
- Page designed for growth — more mailers can be added as acidrain239 writes them
